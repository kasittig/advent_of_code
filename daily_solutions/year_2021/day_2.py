...
class Submarine(object):
    ...
    def execute_instruction_part_1(self, instruction: str) -> None:
    ...
    def execute_instruction_part_2(self, instruction: str) -> None:
        command, value = instruction.split(" ")
        if command == "forward":
            self.horizontal += int(value)
...
class Year2021Day2Solution(BaseDailySolution):
    YEAR = 2021
    DAY = 2
